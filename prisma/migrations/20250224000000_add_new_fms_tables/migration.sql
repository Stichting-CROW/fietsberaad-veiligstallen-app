-- FMS migration: new_* tables only. NO changes to production tables (no ALTER, no indices on wachtrij_*, transacties, etc.).
-- CreateTable
CREATE TABLE `new_wachtrij_transacties` (
...
-- CreateTable
CREATE TABLE `new_wachtrij_pasids` (
    `ID` INTEGER NOT NULL AUTO_INCREMENT,
    `transactionDate` TIMESTAMP(0) NULL,
    `bikeparkID` VARCHAR(8) NOT NULL,
    `passID` VARCHAR(35) NOT NULL,
...
-- CreateTable
CREATE TABLE `new_wachtrij_betalingen` (
    `ID` INTEGER NOT NULL AUTO_INCREMENT,
    `bikeparkID` VARCHAR(8) NOT NULL,
    `passID` VARCHAR(35) NOT NULL,
    `idtype` INTEGER NULL,
...
-- CreateTable
CREATE TABLE `new_wachtrij_sync` (
    `ID` INTEGER NOT NULL AUTO_INCREMENT,
...
-- CreateTable
CREATE TABLE `new_transacties_archief` (
    `ID` INTEGER NOT NULL AUTO_INCREMENT,
...
-- CreateTable
CREATE TABLE `new_accounts_pasids` (
    `ID` VARCHAR(35) NOT NULL,
    ...
    `dateLastSaldoUpdate` TIMESTAMP(0) NULL,
    `dateLastSubscriptionUpdate` TIMESTAMP(0) NULL,
...
-- CreateTable
CREATE TABLE `new_financialtransactions` (
    `ID` VARCHAR(35) NOT NULL,
...
-- Note: FK to fietsenstallingen.StallingsID omitted - locationid references StallingsID format (9933_001)
